...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(emacsql-sqlite-builtin all-the-icons pinentry)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default nil)
   dotspacemacs-line-numbers '(:relative t :disabled-for-modes dired-mode doc-view-mode markdown-mode org-mode pdf-view-mode text-mode :size-limit-kb 1000)
...
before packages are loaded."
  ...
  (spacemacs//set-monospaced-font "Source Code Pro" "Source Han Mono HC" 14 16)
  ...
  (add-hook 'gist-mode-hook
            (lambda () (define-key gist-mode-map [remap evil-write] 'gist-mode-save-buffer)))
  ...
  (defun nixos/post-init-company ()
    (spacemacs|add-company-backends :backends company-nixos-options :modes nix-mode))
